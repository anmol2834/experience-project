      ...
      <div className="account-menu">
        ...
        <div className="profile">
          <section>
            ...
            <span className='edit-profile-icon' onClick={() => navigate('edit_account')}>
        ...
        <div className="profile-menu">
          <div className="profile-menu-btn booked">
          ...
          <div className="profile-menu-btn wishlist-btn">
          ...
          <div className="profile-menu-btn help-center-btn">
            ...
            <span onClick={() => navigate('help_center')}>Help Center</span>
          </div>
        </div>
