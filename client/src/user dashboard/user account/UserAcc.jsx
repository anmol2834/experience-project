...
function UserAcc() {
  ...
  // Update visibility based on route and device
  useEffect(() => {
    if (isMobile) {
      setShowMenu(location.pathname === '/account');
    } else {
      setShowMenu(true); // On desktop, always show menu alongside render
    }
  }, [location.pathname, isMobile]);

  // Fetch user data (unchanged logic)
  useEffect(() => {
    ...
    fetchUserData();
  }, [token, navigate, logout, userUpdated]);

  // Handle navigation to nested routes
  const handleNavigation = (path) => {
    navigate(path);
    if (isMobile) {
      setShowMenu(false); // Hide menu, show content on mobile
    }
  };
  ...
  const handleBack = () => {
    if (isMobile) {
      setShowMenu(true); // Show menu, hide content
      navigate('/account'); // Navigate back to main account page
    }
  };
      ...
      >
        ...
        <div className="profile">
          <section>
            ...
            <span className='edit-profile-icon' onClick={() => handleNavigation('edit_profile')}>
        ...
        <div className="profile-menu">
          <div onClick={() => handleNavigation('bookings')} className="profile-menu-btn booked">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000">
          ...
          <div onClick={() => handleNavigation('wishlist')} className="profile-menu-btn wishlist-btn">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000">
          ...
          <div onClick={() => navigate('rewards')} className="profile-menu-btn rewards-btn">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000">
          ...
          <div onClick={() => handleNavigation('help_center')} className="profile-menu-btn help-center-btn">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000">
        ...
        <div className="address-section">
          <section>
            <h2>Saved Address :</h2>
            <span className='add-address' onClick={() => handleNavigation('address')} style={{fontSize: '1.5rem'}}>
