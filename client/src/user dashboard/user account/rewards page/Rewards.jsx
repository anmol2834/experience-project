      ...
      >
        ...
        <div className="experience-gallery">
          ...
          <div className="gallery-grid">
            {[
              { title: 'Mountain Trek', xp: 1500, image: 'https://picsum.photos/300/200?mountain' },
              { title: 'Cave Diving', xp: 2000, image: 'https://picsum.photos/300/200?cave' },
              { title: 'Desert Safari', xp: 1800, image: 'https://picsum.photos/300/200?desert' }
            ].map((exp, index) => (
              <div 
                key={index}
