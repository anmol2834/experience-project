      ...
      <div className="terms-content">
        <div className="terms-nav">
          ...
          <div className="nav-items-container">
            ...
            {/* Contact Us Navigation Item Added Here */}
            <div className="nav-item">
        ...
        <div className="terms-sections">
            ...
            <div className="policy-grid">
              <div className="policy-card">
                ...
                <div className="policy-item">
                  ...
                  <div className="policy-text">Service bookings can only be canceled within 48 hours of purchase</div>
                </div>
                <div className="policy-item">
                  <div className="policy-bullet">-</div>
                  <div className="policy-text">Once the event preparation has begun or less than 72 hours remain before the event, no cancellation will be entertained.</div>
                </div>
              </div>
              ...
              <div className="policy-card">
                ...
                <div className="policy-item">
                  <div className="policy-bullet">-</div>
                  <div className="policy-text">Since our services include unique in-person experiences, we do not offer physical products that can be returned.</div>
                </div>
              </div>
              ...
              <div className="policy-card">
                ...
                <div className="policy-item">
                  <div className="policy-bullet">-</div>
                  <div className="policy-text">Once cancellation successfully, Rishiraj Rajesh Sinha will instantly
                    initiate the refund to your source account or chosen method of refund.
                  </div>
                </div>
                <div className="policy-item">
                  <div className="policy-bullet">-</div>
                  <div className="policy-text">Refunds will be processed within 7–10 business days from the cancellation date</div>
                </div>
              </div>
            </div>
          ...
          {/* Added id="contact" to this section */}
          <section id="contact" className="terms-section">
            ...
            <div className="contact-info">
              <div className="contact-item">
                <span className="contact-label">Company Holder Name :</span>
                <span className="contact-value">Rishiraj Rajesh Sinha</span>
              </div>
              <div className="contact-item">
